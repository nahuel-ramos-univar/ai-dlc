...
Do not regenerate BUGBOT.md during each review. Propose an update only when observed repository invariants or recurring bug risks make the existing guidance materially stale. Keep IAM, Terraform apply gates, and DevOps-owned role work in governance findings, not in BUGBOT.md.
